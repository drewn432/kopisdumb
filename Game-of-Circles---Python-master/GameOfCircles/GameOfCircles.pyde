...
def setup():
    ...
    sprites.append(Raindrop(170, 150, enemyTeam))
    sprites.append(Raindrop(190, 150, enemyTeam))
    sprites.append(Raindrop(210, 150, enemyTeam))
    sprites.append(Raindrop(230, 150, enemyTeam))
